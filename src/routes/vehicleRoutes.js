...
const { getVehiclesHandler, getActiveVehiclesHandler, getVehiclesByLicensePlateHandler, getActiveVehiclesByLicensePlateHandler, postVehicleHandler } = require('../handlers/vehicleHandlers/indexHandlers.js');
