...
const { getPersonClientsHandler, getPersonClientByIdHandler, getActivePersonClientsHandler, getPersonClientsByDniHandler, getActivePersonClientsByDniHandler, getPersonClientsByNameHandler, getActivePersonClientsByNameHandler, getActivePersonClientsByVehicleHandler, getPersonClientsByVehicleHandler, postPersonClientHandler, putPersonClientHandler, putPersonClientStatusHandler } = require('../handlers/personClientHandlers/indexHandlers.js');
...
personClientRouter.put('/status/:id', putPersonClientStatusHandler);
